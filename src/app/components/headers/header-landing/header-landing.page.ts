...
import { IonHeader, IonTitle, IonToolbar, IonButton, IonIcon, MenuController } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonIcon, IonButton, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
